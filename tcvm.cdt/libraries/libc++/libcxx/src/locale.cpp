...
extern "C" void tc_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { tc_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { tc_assert(false, "strftime_l called"); }
